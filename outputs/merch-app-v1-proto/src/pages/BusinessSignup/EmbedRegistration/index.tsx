...
import { PaymentDisclaimerColombiacu } from '../components/PaymentDisclaimer';
...
import { PROMO_CODE_COLUMBIACU } from '@shared/constants';

const EmbedRegisterPage: React.FC = () => {
  ...
  const {
    ...
    refetch: refetchPaymentToken } = useGetPaymentToken(false);
  const { mutateAsync: postBusinessRegistrationInProgressData, isPending: isPostRegistrationInProgressPending } = usePostRegistrationInProgress();
  ...
  */
      ...
      if (
        ...
        const res = await postBusiness({
          ...
          billingInfo: {
            ...
            promoCode: PROMO_CODE_COLUMBIACU,
            params: {
              cardHolderFirstName,
              cardHolderLastName,
              cardToken,
  ...
  } = useGetMembershipPrice(watchedNumberOfLocations, PROMO_CODE_COLUMBIACU);
...
export default EmbedRegisterPage;
